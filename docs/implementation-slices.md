...
Task 45 projected capability at 40% while this stable headline remains 25%.
...
future one-cycle runner consumes them.
...
- `controlled-loop-run-summary`, `controlled-loop-outcome-plan`, and
