...
- `controlled-loop-runner-stage-execute` can now consume the saved invocation
  boundary plus upstream runner packets, recheck the full chain and exact
  boundary checksum, execute exactly one approved stage command with
