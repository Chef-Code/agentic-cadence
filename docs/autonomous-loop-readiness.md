...
- A read-only `loop-tick` now stitches snapshot, candidate election, Cadence
  ...
  reviewable manifest, all without starting a runner, retrying an executor,
  continuing the loop, starting a PR action, writing GitHub state, or merging.
