...
Current unattended-operation confidence: 25% (stable headline; progress log records Task 50 projected capability at 45%)
...
dry-run evidence. It still cannot
...
headline; the progress log records Task 50 projected capability at 45%.
