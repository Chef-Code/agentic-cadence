...
REQUIRED_TOKENS = {
    ...
    "docs/roadmap.md": (
        ...
        "Tasks 1-72 complete",
        "Task 72 projected capability at 67%",
    ...
    "docs/progress-log.md": (
        ...
        "controlled-loop-tick.v1",
        "controlled_loop_tick",
        "Task 72: controlled runner stage retry invocation boundary",
        "controlled-loop-runner-stage-retry-boundary",
        "controlled-loop-runner-stage-retry-boundary.v1",
        "revalidates the saved operator approval",
        "overwriting input evidence",
