...
REQUIRED_TOKENS = {
    ...
    "README.md": (
        ...
        "controlled-loop-runner-stage-retry-boundary",
        "controlled-loop-runner-stage-retry-boundary.v1",
        "controlled_loop_runner_stage_retry_boundary",
        "controlled-loop-runner-stage-retry-closeout",
        "controlled-loop-runner-stage-retry-closeout.v1",
        "controlled_loop_runner_stage_retry_closeout",
        "stage_retry_closeout_status",
        "controlled-loop-runner-stage-retry-outcome-plan",
        "controlled-loop-runner-stage-retry-outcome-plan.v1",
        "controlled_loop_runner_stage_retry_outcome_plan",
        "stage_retry_outcome_decision",
        "second_retry_planning_target",
        "controlled-loop-runner-stage-retry-inspection-preparation",
        "controlled-loop-runner-stage-retry-inspection-preparation.v1",
        "controlled_loop_runner_stage_retry_inspection_preparation",
        "inspection_target",
        "inspection_target_checksum",
        "inspection_kind",
        "inspection_preparation",
        "inspection_preparation_checksum",
        "controlled-loop-runner-executor-invocation-readiness",
        ...
        "controlled_loop_runner_executor_invocation",
        "--executor-invocation-plan-file",
        "--expected-executor-invocation-plan-checksum",
        "runner_executor_invocation_status",
        ...
        "Cadence-owned Git/GitHub writes",
        "approved executor command remains governed by command policy",
        "closeout rechecks the saved `controlled_runner_executor_invocation_readiness` bridge",
        ...
        "controlled_runner_executor_invocation_readiness",
        ...
        "purpose: executor_invocation_readiness",
        "executor_invocation_readiness",
        "complete_runner_after_retry",
        "retry_boundary_prepared_not_started",
        ...
        "start a process",
        "emit stage-execution readiness",
        "select another stage",
        "append audit evidence",
        "invoke an executor",
        "write Git/GitHub state",
        "saved `operator-approval.v1`",
        "output file to be new, inside the runtime root",
    ...
    "docs/protocol.md": (
        ...
        "stage_retry_boundary_checksum",
        "--retry-attempt",
        "Only retry attempt `1`",
        "--expected-operator-id",
        "--approval-secret-env",
        "must not start a runner",
        "start a process",
        "execute a retry",
        ...
        "call GitHub\nAPIs",
        "operator approval\nverifier",
        "executor-task approval",
        "retry\napproval target is recomputed",
        "embedded prior-stage-output",
        "output file must be new, inside the runtime root",
        ...
        "controlled-loop-runner-stage-retry-execute",
        "controlled-loop-runner-stage-retry-execution.v1",
        "controlled_loop_runner_stage_retry_execution",
        "stage_retry_executed_once",
        "stage_retry_process_started",
        "stage_retry_output_written",
        "controlled_runner_stage_retry_execution_audit_appended",
        ...
        "controlled_runner_stage_retry_execution_audit_append_failed",
        "stage-retry-execution-reservations/",
        "controlled-loop-runner-stage-retry-execution-reservation.v1",
        "controlled-loop-runner-stage-retry-closeout",
        "controlled-loop-runner-stage-retry-closeout.v1",
        "controlled_loop_runner_stage_retry_closeout",
        "stage_retry_closeout_only",
        "stage_retry_closeout_status",
        ...
        "controlled-loop-runner-stage-retry-outcome-plan.v1",
        "controlled_loop_runner_stage_retry_outcome_plan",
        "stage_retry_outcome_planned",
        "stage_retry_outcome_decision",
        "select_next_stage_after_retry",
        "complete_runner_after_retry",
        "inspect_stage_retry_failure",
        "inspect_stage_retry_blocked",
        "second_retry_planning_target",
        ...
        "controlled-loop-runner-stage-retry-inspection-preparation.v1",
        "controlled_loop_runner_stage_retry_inspection_preparation",
        "stage_retry_inspection_prepared",
        "inspection_target",
        "inspection_target_checksum",
        "inspection_kind",
        "inspection_preparation",
    ...
    "docs/roadmap.md": (
        ...
        "controlled-loop-tick.v1",
        "controlled_loop_tick",
        "read-only controlled runner stage-retry boundary evidence",
        "controlled runner single retry execution evidence",
        "read-only controlled runner retry closeout/outcome planning evidence",
        "read-only controlled runner post-retry target consumption evidence",
        "read-only controlled runner retry inspection-preparation evidence",
        "read-only controlled runner executor invocation readiness evidence",
        "read-only runner-bound executor invocation readiness/plan consumption evidence",
        "controlled runner executor invocation evidence",
        "Tasks 1-79 complete",
        "Task 79 projected capability at 74%",
    ...
    "docs/implementation-slices.md": (
        ...
        "Task 79 projected capability at 74%",
        "controlled-loop-runner-stage-retry-execute",
        "one approved retry subprocess",
        "controlled-loop-runner-stage-retry-closeout",
        "controlled-loop-runner-stage-retry-outcome-plan",
        "post-retry operator target",
        "controlled-loop-runner-stage-retry-boundary",
        "approval-secret-backed signature",
        "overlapping input evidence",
        "preserves ownership arguments",
    ...
    "docs/progress-log.md": (
        ...
        "controlled-loop-tick.v1",
        "controlled_loop_tick",
        "Retry inspection preparation",
        "Task 79: failed/blocked retry inspection target consumption",
        "controlled-loop-runner-stage-retry-inspection-preparation",
        "controlled-loop-runner-stage-retry-inspection-preparation.v1",
        "New projected capability: 74%",
        "Task 77: consume controlled runner executor invocation readiness",
        "controlled_runner_executor_invocation_readiness",
        "Runner-launched executor invocation",
        "Task 78: runner-launched controlled executor invocation",
        "controlled-loop-runner-executor-invocation",
        "controlled-loop-runner-executor-invocation.v1",
        "New projected capability: 73%",
        "Runner-bound executor invocation readiness consumption",
        "New projected capability: 72%",
        "Task 76: post-retry target consumption",
        "controlled-loop-runner-next-stage-continuation",
        "controlled-loop-runner-completion",
        "New projected capability: 71%",
        "Task 75: runner-launched executor invocation readiness",
        "controlled-loop-runner-executor-invocation-readiness",
        "controlled-loop-runner-executor-invocation-readiness.v1",
        "executor_invocation_readiness_target",
        "New projected capability: 70%",
        "Task 74: controlled runner retry closeout and outcome planning",
        "controlled-loop-runner-stage-retry-closeout",
        "controlled-loop-runner-stage-retry-closeout.v1",
        "controlled-loop-runner-stage-retry-outcome-plan",
        "controlled-loop-runner-stage-retry-outcome-plan.v1",
        "post-retry operator target",
        "second retry planning target",
        "New projected capability: 69%",
        "Task 73: controlled runner stage retry execution",
        "controlled-loop-runner-stage-retry-execute",
        "controlled-loop-runner-stage-retry-execution.v1",
        "reviewed retry boundary checksum",
        "exactly one approved subprocess",
        "post-start audit record",
    ...
    "codex_cadence/cli.py": (
        ...
        "controlled_loop_runner_executor_invocation",
        "controlled-loop-runner-executor-invocation",
        "controlled_loop_runner_executor_invocation_command",
    ...
    "codex_cadence/policy_audit.py": (
        ...
        "validate_controlled_runner_stage_retry_execution_audit_record",
        "record_controlled_runner_stage_retry_execution",
